...
\begin{columns}
	\begin{column}{0.5\textwidth}
		\begin{figure}
  			...
  			\caption{\tthigh{Projects} fanen i PlatformIO, med markeret indstilling for at indlæse et projekt fra disk}
	...
	\begin{column}{0.5\textwidth}
		\begin{textBox}
			\begin{itemize}
				...
				\item Under \tthigh{Projects} fanen, klik \tthigh{Add Existing}
			\end{itemize}
		\end{textBox}
	\end{column}
\end{columns}
...
\begin{columns}
	...
	\begin{column}{0.5\textwidth}
		\begin{textBox}
			\begin{itemize}
				\item Når projektet er indlæst vises \tthigh{platformio.ini} for projektet
